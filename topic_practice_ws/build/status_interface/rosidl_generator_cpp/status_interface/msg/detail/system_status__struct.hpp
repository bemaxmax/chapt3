...
struct SystemStatus_
{
  ...
  using _memory_availiable_type =
    float;
  _memory_availiable_type memory_availiable;
  ...
  Type & set__memory_availiable(
    const float & _arg)
  {
    this->memory_availiable = _arg;
    return *this;
  }
  Type & set__net_sent(
    const double & _arg)
  ...
  bool operator==(const SystemStatus_ & other) const
  {
    ...
    if (this->memory_availiable != other.memory_availiable) {
      return false;
    }
