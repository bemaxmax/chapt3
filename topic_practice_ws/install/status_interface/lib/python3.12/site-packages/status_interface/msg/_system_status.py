...
class SystemStatus(metaclass=Metaclass_SystemStatus):
    ...
    def __init__(self, **kwargs):
        ...
        self.memory_availiable = kwargs.get('memory_availiable', float())
    ...
    def __eq__(self, other):
        ...
        if self.memory_total != other.memory_total:
            return False
        if self.memory_availiable != other.memory_availiable:
            return False
    ...
    @builtins.property
    def memory_availiable(self):
        """Message field 'memory_availiable'."""
        return self._memory_availiable

    @memory_availiable.setter
    def memory_availiable(self, value):
        if self._check_fields:
            assert \
                isinstance(value, float), \
                "The 'memory_availiable' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'memory_availiable' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._memory_availiable = value
